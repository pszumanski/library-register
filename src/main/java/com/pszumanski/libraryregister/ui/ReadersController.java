...
import com.pszumanski.libraryregister.managers.inputManagers.factories.*;
...
public class ReadersController {
    ...
    public void loadReadersAdd() {
        try {
            ...
            this.readerDateColumnAdd.setCellValueFactory(readerData -> {
                return new SimpleStringProperty(readerData.getValue().getBornDate().toString());
            });
    ...
    public void addReader() {
        ...
        NotificationController.notification(FxmlUtils.getResourceBundle().getString("readerAdded"),
    ...
    private void deleteReader() {
        ...
        returnBookButton.setDisable(true);
        payPenaltyButton.setDisable(true);
        NotificationController.notification(FxmlUtils.getResourceBundle().getString("readerRemoved"),
    ...
    private void lengthenDeadline() {
        NotificationController.notification(FxmlUtils.getResourceBundle().getString("deadlineLengthened"),
